                ...
                <form onSubmit={this.formSubmit}>
                    <div className="row col-lg-10 mx-auto">
                        ...
                        <div className="col-lg-6 md-form"style={{color: 'red'}}>
                            <input type="text" name="extra_1" className="form-control" 
                        ...
                        <div className="col-lg-6 md-form">
                            <input type="text" name="extra_2" className="form-control" 
                    ...
                    <div className="row col-lg-10 mx-auto">
                        ...
                        <div className="col-lg-6 md-form">
                            <input type="text" name="extra_3" id="extra_3" className="form-control" 
                            // defaultValue={values.status === 1 ? '' : values.extra_3} 
                            onChange={handleChange} required />
                            <label htmlFor="extra_3">Achievement / Other</label>
                        </div>
                        <div className="col-lg-6 md-form">
                            <input type="text" name="extra_4" id="extra_4" className="form-control" 
                    ...
                    <div className="row col-lg-10 mx-auto">
                        <div className="col-lg-12 md-form">
                            <input type="text" name="extra_5" id="extra_5" className="form-control" 
